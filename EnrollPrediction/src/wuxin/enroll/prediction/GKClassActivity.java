...
import wuxin.enroll.prediction.fragments.GKClassFragment;

public class GKClassActivity extends FragmentActivity {
    ...
    private void initView() {
        ...
        GKClassFragment mClass = new GKClassFragment();
        transaction.replace(R.id.id_ly_container, mClass);
        transaction.commit();
    }
}
