...
import wuxin.enroll.prediction.fragments.RegisterUserInfoFragment;

public class RegisterUserInfoActivity extends FragmentActivity {
    @Override
    ...
    private void initView() {
        ...
        title.setText("…Ë÷√√‹¬Î∫ÕÍ«≥∆");
        
        FragmentManager fm = getSupportFragmentManager();
        FragmentTransaction transaction = fm.beginTransaction();
        RegisterUserInfoFragment mRegisterUserInfo = new RegisterUserInfoFragment();
        transaction.replace(R.id.id_ly_container, mRegisterUserInfo);
        transaction.commit();
    }
}