...
import wuxin.enroll.prediction.fragments.ChangePassFragment;
...
public class ChangePassActivity extends FragmentActivity {
    ...
    private void initView() {
        ...
        ChangePassFragment mChangePass = new ChangePassFragment();
        transaction.replace(R.id.id_ly_container, mChangePass);
        transaction.commit();
    }
}