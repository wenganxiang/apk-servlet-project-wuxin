...
import wuxin.enroll.prediction.fragments.FindPassFregment;
...
public class FindPassActivity extends FragmentActivity {
    ...
    private void initView() {
        ...
        FindPassFregment mFindPass = new FindPassFregment();
        transaction.replace(R.id.id_ly_container, mFindPass);
        transaction.commit();
    }
}