...
import wuxin.enroll.prediction.fragments.LoginFragment;
import wuxin.enroll.prediction.fragments.RegisterFregment;
...
public class LoginActivity extends FragmentActivity {
    ...
    private void initView() {
        ...
        RegisterFregment mRegister = new RegisterFregment();
        transaction.replace(R.id.topItem3, mRegister);
        
        LoginFragment mlogin = new LoginFragment();
        transaction.replace(R.id.id_ly_container, mlogin);
        transaction.commit();
    }
}
